...
network={
    ...
    def test_set_country_no_countries_file(self):
        ...
        with self.assertRaises(Exception) as cm:
            self.w.set_country('france')
        self.assertEqual(cm.exception.message, 'Invalid country code "france" specified')
    ...
    def test_encrypt_password_invalid_parameters(self):
        ...
        self.assertEqual(cm.exception.message, 'Parameter network is missing')
        with self.assertRaises(MissingParameter) as cm:
        ...
        self.assertEqual(cm.exception.message, 'Parameter password is missing')
        with self.assertRaises(MissingParameter) as cm:
            self.w.encrypt_password('mynetwork', '')
        self.assertEqual(cm.exception.message, 'Parameter password is missing')
        with self.assertRaises(InvalidParameter) as cm:
            self.w.encrypt_password('mynetwork', 'azer')
        self.assertEqual(cm.exception.message, 'Parameter password must be 8..63 string length')
        with self.assertRaises(InvalidParameter) as cm:
    ...
    def test_encrypt_password_invalid_command(self):
        ...
        self.assertEqual(cm.exception.message, 'Error with wpa_passphrase: unable to encrypt it')
        ...
        with self.assertRaises(Exception) as cm:
            self.w.encrypt_password('mynetwork', 'mypassword')
        self.assertEqual(cm.exception.message, 'Error with wpa_passphrase: invalid command output')
        ...
        with self.assertRaises(Exception) as cm:
            self.w.encrypt_password('mynetwork', 'mypassword')
        self.assertEqual(cm.exception.message, 'No password generated by wpa_passphrase command')
