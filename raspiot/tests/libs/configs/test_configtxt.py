...
logging.basicConfig(level=TRACE, format=u'%(asctime)s %(name)s %(levelname)s : %(message)s')
...
if __name__ == '__main__':
    #coverage run --omit="/usr/local/lib/python2.7/*","test_*" --concurrency=thread test_configtxt.py
    #coverage report -m
    unittest.main()
