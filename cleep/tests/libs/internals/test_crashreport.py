...
class CrashReportTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.sentry_configure_scope.return_value.__enter__.return_value = (
        ...
        self.c = crashreport.CrashReport(
            "mytoken", "myproduct", "myversion", {"mylib": "mylibversion"}
        )
    ...
    def test_init(self):
        ...
        self.assertGreaterEqual(
            self.sentry_configure_scope.return_value.__enter__.return_value.set_tag_calls,
            7,
        )
    ...
    def test_check_disabled_at_startup(self):
        ...
        c = crashreport.CrashReport(
            "mytoken", "myproduct", "myversion", disabled_by_core=True
        )
        self.assertFalse(c.is_enabled())
    ...
    def test_report_exception(self):
        ...
        self.assertGreater(
            self.sentry_push_scope.return_value.__enter__.return_value.set_extra_calls,
            0,
        )
    ...
    def test_get_infos(self):
        ...
        self.assertDictEqual(
            infos,
            {
                "libsversion": {"mylib": "mylibversion"},
                "product": "myproduct",
