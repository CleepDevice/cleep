...
pip install --no-cache-dir --trusted-host pypi.python.org "future==0.17.1" "six==1.12.0" "gevent==1.4.0" "bottle==0.12.16" "pyre-gevent==0.2.3" "netifaces==0.10.9" "uptime==3.0.1" "urllib3==1.24.2" "psutil==5.6.1" "passlib==1.7.1" "simplejson==3.16.0" "raven==6.10.0" "pytz==2019.1" "reverse-geocode==1.3" "timezonefinder==3.4.2" "tzlocal==1.5.1"
checkResult $? 0
echo "Done"
echo ""
